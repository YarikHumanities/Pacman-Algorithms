...
class ReflexAgent(Agent):
    ...
    def evaluationFunction(self, currentGameState: GameState, action):
        ...
        return successorGameState.getScore() + 1.0/min_food_list
...
class MinimaxAgent(MultiAgentSearchAgent):
    ...
    def getAction(self, gameState: GameState):
        ...
        for action in possibleActions:
            action_scores.append(self.minimax(0, 0, gameState.generateSuccessor(0, action)))
    ...
    def minimax(self, agent, depth, gameState):
        ...
        if agent == 0:  # pacman
            ...
            for action in legal_actions:
                temp = self.minimax(1, depth, gameState.generateSuccessor(agent, action))
